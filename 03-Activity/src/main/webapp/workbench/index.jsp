...
<head>
	...
	//
	//调用crm.js校验表单项, 查看是否为空，以及新密码是否和确认密码一致，
	function validateForm() {
		var crm = new CRM();
		var formItem1 = new FormItem("原密码","oldPwd");
		var formItem2 = new FormItem("新密码","newPwd");
		var formItem3 = new FormItem("确认密码","confirmPwd");
		var formItemArr = [formItem1,formItem2, formItem3];
		if (!crm.isNotEmpty(formItemArr)){ return false;}
		//判断非空后返回判断是否一致的结果
		return crm.isSame(formItem2,formItem3);
	}
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						允许访问IP：<b>${sessionScope.user.allowIps == ""? "不设限制IP": sessionScope.user.allowIps}</b>
					</div>
				</div>
