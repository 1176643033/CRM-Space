...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> getActivityListForClue(Map<String,Object> param) {
        return activityDao.getActivityListForClue(param);
    }

    @Override
    public List<Activity> getActivityListInRelation(Map<String,Object> param) {
        return activityDao.getActivityListInRelation(param);
    }

    @Override
    public List<Activity> getListByLikeName(String condition) {
        return activityDao.getListByLikeName(condition);
    }
}
